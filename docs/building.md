...
* [Boost 1.70.0](https://sourceforge.net/projects/boost/files/boost/1.70.0/boost_1_70_0.7z/download), extracted to a path defined by the environment variable `BOOST_ROOT`.
