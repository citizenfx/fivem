...
* [Modified CEF](https://runtime.fivem.net/build/cef/cef_binary_83.0.0-shared-textures.2175+g5430a8e+chromium-83.0.4103.0_windows64_minimal.zip), extracted to `vendor/cef` in the build tree.
