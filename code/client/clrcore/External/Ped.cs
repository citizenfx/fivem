...
#endif
{
	...
	public enum VehicleDrivingFlags : uint
	{
		...
		DrivingModeStopForVehicles = StopForVehicles | StopForPeds | AvoidObjects | AvoidEmptyVehicles | StopAtTrafficLights | UseShortCutLinks | ChangeLanesAroundObstructions,
		DrivingModeStopForVehiclesStrict = StopForVehicles | StopForPeds | StopAtTrafficLights | UseShortCutLinks,
		DrivingModeAvoidVehicles = AvoidVehicles | AvoidObjects | UseShortCutLinks | ChangeLanesAroundObstructions | StopForVehicles,
		DrivingModeAvoidVehiclesReckless = AvoidVehicles | AvoidObjects | UseShortCutLinks | ChangeLanesAroundObstructions,
		DrivingModePloughThrough = UseShortCutLinks,
		DrivingModeStopForVehiclesIgnoreLights = StopForVehicles | AvoidEmptyVehicles | StopForPeds | AvoidObjects | UseShortCutLinks | ChangeLanesAroundObstructions,
		DrivingModeAvoidVehiclesObeyLights = AvoidVehicles | StopAtTrafficLights | AvoidObjects | UseShortCutLinks | ChangeLanesAroundObstructions | StopForVehicles,
		DrivingModeAvoidVehiclesStopForPedsObeyLights = AvoidVehicles | StopAtTrafficLights | StopForPeds | AvoidObjects | UseShortCutLinks | ChangeLanesAroundObstructions | StopForVehicles,
