return {
	include = function()
		includedirs { "../vendor/grpc/include/" }
	end,
	...
	run = function()
		...
		defines { "GPR_WINDOWS", "_WIN32_WINNT=0x600", "GRPC_ARES=0" }
		
		add_dependencies { "vendor:zlib", "vendor:openssl_crypto", "vendor:openssl_ssl" }
		
		includedirs {
			"../vendor/grpc/",
			"../vendor/grpc/third_party/upb/",
			"../vendor/grpc/src/core/ext/upb-generated/"
		}
		
		buildoptions "/MP /wd4065 /wd4506 /wd4200 /wd4291 /wd4244 /wd4267 /wd4987 /wd4774 /wd4819 /wd4996 /wd4619"
		
		files_project '../vendor/grpc/' {
			-- gpr
