...
struct ConsoleArgumentType<fx::GameBuild>
{
	...
	static bool Parse(const std::string& input, fx::GameBuild* out)
	{
		...
		else if (_stricmp(inputStr.c_str(), "mp2024_02") == 0)
		{
			*out = "3407";
			return true;
		}
		else if (_stricmp(inputStr.c_str(), "mp2025_01") == 0)
		{
			*out = "3570";
			return true;
		}
		else if (_stricmp(inputStr.c_str(), "mp2025_02") == 0)
		{
			*out = "3751";
			return true;
		}
		else if (_stricmp(inputStr.c_str(), "mp2026_patch_01") == 0)
		{
			*out = "3788";
			return true;
		}
		else if (_stricmp(inputStr.c_str(), "mp2026_01") == 0)
		{
			*out = "3889";
			return true;
		}
