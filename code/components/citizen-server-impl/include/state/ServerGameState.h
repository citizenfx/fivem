...
inline PoolIndex GetPoolForEntityType(sync::NetObjEntityType entityType)
{
	switch (entityType)
	{
#ifdef STATE_FIVE
		...
		case sync::NetObjEntityType::Train:
			return PoolIndex::CNetObjVehicle;
		case sync::NetObjEntityType::Door:
			return PoolIndex::CNetObjDoor;
		case sync::NetObjEntityType::Player:
		case sync::NetObjEntityType::Ped:
			return PoolIndex::CNetObjPed;
		case sync::NetObjEntityType::Pickup:
			return PoolIndex::CNetObjPickup;
		case sync::NetObjEntityType::PickupPlacement:
			return PoolIndex::CNetObjPickupPlacement;
		case sync::NetObjEntityType::Object:
			return PoolIndex::CNetObjObject;
#endif
		default:
			return PoolIndex::Base;
	}
}

inline int GetLimitForPool(PoolIndex pool)
{
	switch (pool)
	{
#ifdef STATE_FIVE
		case PoolIndex::CNetObjDoor:
			return 20;
		case PoolIndex::CNetObjObject:
			return 70;
		case PoolIndex::CNetObjPickup:
			return 80;
		case PoolIndex::CNetObjPickupPlacement:
			return 50;
		case PoolIndex::CNetObjPed:
			return 238;
		// *may* need subdivision into individual pool types for game object?
		case PoolIndex::CNetObjVehicle:
			return 250;
#endif
		default:
