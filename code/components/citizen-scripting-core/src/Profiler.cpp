...
static InitFunction initFunction([]()
{
	...
	fx::ScriptEngine::RegisterNativeHandler("PROFILER_SAVE_TO_JSON", [&allowProfilerSaveNatives](fx::ScriptContext& ctx)
	{
	...
	fx::ScriptEngine::RegisterNativeHandler("PROFILER_SAVE_TO_MSGPACK", [&allowProfilerSaveNatives](fx::ScriptContext& ctx)
	{
		const char* path = ctx.CheckArgument<char*>(0);
