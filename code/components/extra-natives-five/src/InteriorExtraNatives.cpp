...
#define GET_INTERIOR_PROXY(interiorId) \
	(xbr::IsGameBuildOrGreater<2060>() ? GetInteriorProxy<2060>(interiorId) : GetInteriorProxy<1604>(interiorId))
#elif IS_RDR3
#define GET_INTERIOR_PROXY(interiorId) GetInteriorProxy<1491>(interiorId)
#endif
