...
static InitFunction initFunction([]()
{
	...
	OnGameFrame.Connect([]()
	{
		...
		GatherPool("Peds", fx::sync::NetObjEntityType::Ped, samples);
		GatherPool("CVehicle", fx::sync::NetObjEntityType::Automobile, samples);
		GatherPool("Object", fx::sync::NetObjEntityType::Object, samples);
