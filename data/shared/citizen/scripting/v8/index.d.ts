...
declare function emitNet(eventName: string, target: number|string|(number|string)[], ...args: any[]): void
declare function TriggerClientEvent(eventName: string, target: number|string|(number|string)[], ...args: any[]): void
