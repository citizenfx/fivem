...
local paramOverrides = {
    ...
    ['CFX/TRIGGER_UNRELIABLE_CLIENT_EVENT_INTERNAL/eventPayload'] = PAS_ARG_POINTER | PAS_ARG_BUFFER,
    ['CFX/TRIGGER_UNRELIABLE_SERVER_EVENT_INTERNAL/eventPayload'] = PAS_ARG_POINTER | PAS_ARG_BUFFER,
