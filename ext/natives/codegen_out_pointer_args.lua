...
local paramOverrides = {
    ...
    -- eventTargets
    ['CFX/TRIGGER_MULTICAST_CLIENT_EVENT_INTERNAL/1'] = PAS_ARG_POINTER | PAS_ARG_BUFFER,

    -- eventPayload
    ['CFX/TRIGGER_CLIENT_EVENT_INTERNAL/2']          = PAS_ARG_POINTER | PAS_ARG_BUFFER,
    ['CFX/TRIGGER_MULTICAST_CLIENT_EVENT_INTERNAL/3'] = PAS_ARG_POINTER | PAS_ARG_BUFFER,
