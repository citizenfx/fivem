...
apiset: shared
---
## GET_COLSHAPE_CIRCLE_DATA

```c
BOOL GET_COLSHAPE_CIRCLE_DATA(int colShapeId, float* x, float* y, float* radius);
```

Gets the data of a circle collision shape.

## Parameters
* **colShapeId**: The collision shape ID.
* **x**: Center X coordinate output.
* **y**: Center Y coordinate output.
* **radius**: Circle radius output.
