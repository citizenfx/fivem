...
export namespace Icons {
  ...
  export const last24h = (
    <MdTrendingUp />
  );

  export const statusLevelAllGood = (
    <BsCheckCircle />
  );
  export const statusLevelMinor = (
    <BsExclamationCircle />
  );
  export const statusLevelMajor = (
    <BsXCircle />
  );

  export const favoriteInactive = (
    <BsHeart />
  );
  export const favoriteActive = (
    <BsHeartFill className="cfx-color-primary" />
  );
  ...
  export const serversListAll = (
    <VscListFlat />
  );
  export const serversListSupporters = (
    <BsCurrencyDollar />
  );
  export const serversListHistory = (
    <BsClock />
  );
  export const serversListFavorites = favoriteInactive;

  export const serverLastConnected = (
    <BiTime />
  );

  export const serversFeatured = (
    <GiStarsStack style={{ fill: 'url(#pin-gradient)' }} />
  );
  export const serversFeaturedUnstyled = (
    <GiStarsStack />
  );

  export const serverBoost = (
    <IoMdTrendingUp style={{ fill: 'url(#boost-gradient)' }} />
  );
  export const serverBoostUnstyled = (
    <IoMdTrendingUp />
  );
  export const serverBurst = (
    <IoFlame style={{ fill: 'url(#burst-gradient)' }} />
  );
}
