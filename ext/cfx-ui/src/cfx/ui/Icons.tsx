...
import { FaDiscord, FaHouseUser } from "react-icons/fa";
...
export namespace Icons {
  ...
  export const exit2 = <BsX style={{ fontSize: '4.4em' }} />;
  export const BsHousesZ = <FaHouseUser style={{ fontSize: '2.4em' }} />;
  export const FaDiscordZ = <FaDiscord style={{ fontSize: '2.4em' }} />;
