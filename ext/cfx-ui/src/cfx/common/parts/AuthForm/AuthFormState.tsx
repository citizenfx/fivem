...
class AuthFormState {
  ...
  private _username2 = '';
  public get username2(): string { return this._username2 }
  private set username2(username2: string) { this._username2 = username2 }
  ...
  public readonly setusername2 = (username2: string) => {
