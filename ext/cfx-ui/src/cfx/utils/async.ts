...
export const queueMicrotask: (fn: () => any) => void = (globalThis || window).queueMicrotask || ((fn) => Promise.resolve().then(fn));
 ...
 */
export class OnlyLatest<TWorkArgs extends any[], TWorkResult extends any> implements IDisposableObject {
