  ...
  return (
    <>
      ...
      <Pad size="small">
        ...
        Tuyên bố miễn trừ trách nhiệm: Giao diện người dùng ở trên đã được cung cấp bởi máy chủ và <strong>không phải là một phần của giao diện người dùng  VNGTA UI</strong>
        </Text>
      </Pad>
    </>
  );
