...
module.exports = Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('fxdk-game-view/lib/browser/fxdk-game-view-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('fxdk-project/lib/browser/fxdk-project-frontend-module')).then(load) })
