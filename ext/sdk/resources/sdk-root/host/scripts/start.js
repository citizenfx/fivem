...
const env = require('dotenv').parse(fs.readFileSync(path.join(paths.shell, '.env')));
...
function start() {
  return concurrently([
    ...
    { name: 'theia:fxdk-project:watch', command: `yarn --cwd ${paths.personalityTheiaFxdkProject} watch` },
    { name: 'theia:fxdk-app:watch', command: `yarn --cwd ${paths.personalityTheiaBrowserApp} watch` },
    {
      name: 'shell:start',
