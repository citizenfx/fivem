...
function install() {
  ...
  return concurrently([
    { name: 'shell:install', command: `yarn --cwd ${paths.shell} install --pure-lockfile` },
    { name: 'personality-theia:install', command: `yarn --cwd ${paths.personalityTheia} install --pure-lockfile` },
  ]);
}
